...
"Наша вера — вера Закона и Завета", — говорит он, поглаживая свиток.

*   [Спросить о едином Боге]
    "Как один Бог может управлять всем миром?" — спрашиваете вы, привыкший к множеству духов и божков.
    Раввин улыбается: "Как один князь управляет дружиной. Не множество вождей, но один — и порядок." faith_path = "judaism"
    -> after_judaism_choice
    
*   [Спросить о земле и царстве]
    "Но где же ваше царство? Где земля, где правит ваш народ?"
    Лицо старика становится печальным. "Наше царство — в душах и в Законе. Земные же царства преходят..." people_mood -= 1 // Мысль о народе без земли тревожит воина.
    -> after_judaism_choice
...
*   [Спросить о силе и войне]
    ...
    "Война за веру — путь в рай для храброго! Но и милость к побеждённому — заповедь." faith_path = "islam" vladimir_trust += 1 // Князю понравится этот воинственный дух.
    -> after_islam_choice
    
*   [Удивиться запретам]
    "А как же пир после победы? Без вина? И свинины?"
    Имам строго качает головой: "Послушание Богу выше удовольствий тела. Это и есть истинная сила." people_mood -= 1 // Русскому дружиннику такая аскеза кажется чрезмерной.
    -> after_islam_choice
...
*   [Спросить о власти Папы]
    ...
    "Духовная власть — выше светской. Князь должен слушать наставления Церкви," — отвечает священник без тени сомнения. vladimir_trust -= 1 // Эта мысль не понравится Владимиру.
    -> after_catholic_choice
    
*   [Спросить о вере для простого человека]
    "А если человек не знает вашей латыни? Как он поймёт молитву?"
    "Церковь знает, что лучше для его души. Он должен слушать и верить," — говорит священник. beauty_awakened -= 1 // В этом нет той красоты и доступности, о которой говорил грек.
    -> after_catholic_choice
